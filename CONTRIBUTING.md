Contributing to Arora
============================

The Arora project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/arora-project/arora/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Arora project, and is not to be
confused with overall Arora Network Protocol consensus changes.

Whether a pull request is merged into Arora rests with the project merge
...
Patches that change Arora consensus rules are considerably more involved than
...
Where a patchset proposes to change the Arora consensus, it must have been
...
The project leader is the release manager for each Arora release.
