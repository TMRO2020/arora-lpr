...
arora.conf           | contains configuration settings for lprd or lpr-qt
lprd.pid           | stores the process id of lprd while running
...
debug.log           | contains debug information and general logging generated by lprd or lpr-qt
