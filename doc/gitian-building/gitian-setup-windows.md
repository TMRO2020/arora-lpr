...
The build script we'll be using is contained in the Arora github repository ([contrib/gitian-build.py](https://github.com/arora-project/arora/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Arora repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Arora-Project/Arora/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, arora-detached-sigs, and arora GitHub repos.
