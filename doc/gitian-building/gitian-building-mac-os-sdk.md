...
The script [extract-osx-sdk.sh](https://github.com/arora-project/arora/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
arora/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/arora-project/arora/blob/master/doc/README_osx.md) for troubleshooting tips.
