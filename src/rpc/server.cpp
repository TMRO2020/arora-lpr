...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop LPR Coin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "LPR Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Arora features */
        {"arora", "listmasternodes", &listmasternodes, true, true, false},
        {"arora", "getmasternodecount", &getmasternodecount, true, true, false},
        {"arora", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"arora", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"arora", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"arora", "masternodecurrent", &masternodecurrent, true, true, false},
        {"arora", "masternodedebug", &masternodedebug, true, true, false},
        {"arora", "startmasternode", &startmasternode, true, true, false},
        {"arora", "createmasternodekey", &createmasternodekey, true, true, false},
        {"arora", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"arora", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"arora", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"arora", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"arora", "getmasternodescores", &getmasternodescores, true, true, false},
        {"arora", "preparebudget", &preparebudget, true, true, false},
        {"arora", "submitbudget", &submitbudget, true, true, false},
        {"arora", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"arora", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"arora", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"arora", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"arora", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"arora", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"arora", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"arora", "checkbudgets", &checkbudgets, true, true, false},
        {"arora", "mnsync", &mnsync, true, true, false},
        {"arora", "spork", &spork, true, true, false},
...
{
    return "> lpr-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:23202/\n";
}
