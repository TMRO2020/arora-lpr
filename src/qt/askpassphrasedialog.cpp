...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            AroraGUI* window = static_cast<AroraGUI*>(parentWidget());
...
{
    AroraGUI* gui = static_cast<AroraGUI*>(parentWidget());
...
{
    hide();
    static_cast<AroraGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("LPR Coin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your LPRs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
