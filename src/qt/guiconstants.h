...
/* Arora GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "LPR Coin"
#define QAPP_ORG_DOMAIN "lprcoin.com"
#define QAPP_APP_NAME_DEFAULT "LPR Coin-Qt"
#define QAPP_APP_NAME_TESTNET "LPR Coin-Qt-testnet"
