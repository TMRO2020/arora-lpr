...
#ifndef Arora_CORE_NEW_GUI_AroraGUI_H
#define Arora_CORE_NEW_GUI_AroraGUI_H
...
#include "qt/arora/navmenuwidget.h"
#include "qt/arora/topbar.h"
#include "qt/arora/dashboardwidget.h"
#include "qt/arora/send.h"
#include "qt/arora/receivewidget.h"
#include "qt/arora/addresseswidget.h"
#include "qt/arora/coldstakingwidget.h"
#include "qt/arora/masternodeswidget.h"
#include "qt/arora/snackbar.h"
#include "qt/arora/settings/settingswidget.h"
...
/**
  Arora GUI main class. This class represents the main window of the Arora UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class AroraGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit AroraGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~AroraGUI();
...
#endif //Arora_CORE_NEW_GUI_AroraGUI_H
