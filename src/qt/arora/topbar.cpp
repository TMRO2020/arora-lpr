...
#include "qt/arora/topbar.h"
#include "qt/arora/forms/ui_topbar.h"
#include "qt/arora/lockunlock.h"
#include "qt/arora/qtutils.h"
#include "qt/arora/receivedialog.h"
#include "qt/arora/loadingdialog.h"
...
TopBar::TopBar(AroraGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopLPR}, "amount-small-topbar");
    setCssProperty({ui->labelAmountLPR}, "amount-topbar");
    setCssProperty({ui->labelPendingLPR, ui->labelImmatureLPR}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("Arora")
    updateDisplayUnit();
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // LPR Total
    QString totalLPR = GUIUtil::formatBalance(balance, nDisplayUnit);

    // LPR
    // Top
    ui->labelAmountTopLPR->setText(totalLPR);
    // Expanded
    ui->labelAmountLPR->setText(totalLPR);
    ui->labelPendingLPR->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureLPR->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}
