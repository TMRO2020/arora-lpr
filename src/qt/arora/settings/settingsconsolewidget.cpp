...
#include "qt/arora/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/arora/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(AroraGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
	...
	message(CMD_REPLY, (tr("Welcome to the LPR Coin RPC console.") + "<br>" +
