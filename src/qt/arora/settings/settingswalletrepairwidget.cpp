...
#include "qt/arora/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/arora/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(AroraGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to AroraGUI::handleRestart()
