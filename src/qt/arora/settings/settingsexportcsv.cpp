...
#include "qt/arora/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(AroraGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("Arora_tx_csv_export(*.csv)") : tr("Arora_addresses_csv_export(*.csv)"),
                                        nullptr);
