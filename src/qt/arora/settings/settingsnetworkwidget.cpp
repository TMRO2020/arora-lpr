...
#include "qt/arora/settings/settingsnetworkwidget.h"
#include "qt/arora/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/arora/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(AroraGUI* _window, QWidget *parent) :
