...
#include "qt/arora/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(AroraGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &AroraGUI::openFAQ);
