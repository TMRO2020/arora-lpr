...
#include "qt/arora/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/arora/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(AroraGUI* _window, QWidget *parent) :
