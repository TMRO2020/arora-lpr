...
#include "qt/arora/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/arora/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(AroraGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableLPR,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableLPR,
    ...
    connect(ui->pushButton_UnspendableLPR, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableLPR);});
    ...
    if (parent)
        connect(parent, &AroraGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
