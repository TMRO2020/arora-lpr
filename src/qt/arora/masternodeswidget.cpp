...
#include "qt/arora/forms/ui_masternodeswidget.h"

#include "qt/arora/qtutils.h"
#include "qt/arora/mnrow.h"
#include "qt/arora/mninfodialog.h"
#include "qt/arora/masternodewizarddialog.h"
...
#include "util.h"
#include "qt/arora/optionbutton.h"
#include <iostream>
#include <fstream>
...
MasterNodesWidget::MasterNodesWidget(AroraGUI *parent) :
    PWidget(parent),
    ...
    if (fs::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:23201 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= GetMNCollateral(chainActive.Height()) * COIN) {
        inform(tr("Not enough balance to create a masternode, %1 LPR required.").arg(GetMNCollateral(chainActive.Height())));
        return;
    }
    showHideOp(true);
