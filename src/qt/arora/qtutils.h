...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, AroraGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, AroraGUI* gui, double posX = 3);
