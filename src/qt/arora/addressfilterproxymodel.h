...
#ifndef Arora_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define Arora_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //Arora_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
