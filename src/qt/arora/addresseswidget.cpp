...
#include "qt/arora/forms/ui_addresseswidget.h"
#include "qt/arora/addresslabelrow.h"
#include "qt/arora/addnewaddressdialog.h"
#include "qt/arora/tooltipmenu.h"
...
AddressesWidget::AddressesWidget(AroraGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination lprAdd = DecodeDestination(address.toUtf8().constData(), isStakingAddress);
        ...
        if (walletModel->updateAddressBookLabels(lprAdd, label.toUtf8().constData(),
