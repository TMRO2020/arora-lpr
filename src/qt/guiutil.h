...
/** Utility functions used by the Arora Qt UI.
 */
namespace GUIUtil
{
...
// Render Arora addresses in monospace font
...
// Parse "arora:" URI into recipient object, return true on successful parsing
