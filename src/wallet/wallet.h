...
enum WalletFeature {
    ...
    FEATURE_PRE_Arora = 61000, // inherited version..
...
public:
    ...
    /// Get 1000 LPR output and keys which can be used for the Masternode
     ...
     */
    int64_t IncOrderPosNext(CWalletDB* pwallelpr = NULL);

    void MarkDirty();
    bool AddToWallet(const CWalletTx& wtxIn, bool fFromLoadWallet, CWalletDB* pwallelpr);
    ...
    bool AddAccountingEntry(const CAccountingEntry&, CWalletDB & pwallelpr);
    ...
    bool SetMinVersion(enum WalletFeature, CWalletDB* pwallelprIn = NULL, bool fExplicit = false);
...
public:
    ...
    bool WriteToDisk(CWalletDB *pwallelpr);
