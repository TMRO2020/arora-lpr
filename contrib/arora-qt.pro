...
RESOURCES += src/qt/arora.qrc src/qt/lpr_locale.qrc

TRANSLATIONS += src/qt/locale/lpr_bg.ts \
                src/qt/locale/lpr_de.ts \
                src/qt/locale/lpr_en.ts \
                src/qt/locale/lpr_es.ts \
                src/qt/locale/lpr_fi.ts \
                src/qt/locale/lpr_fr.ts \
                src/qt/locale/lpr_it.ts \
                src/qt/locale/lpr_ja.ts \
                src/qt/locale/lpr_pl.ts \
                src/qt/locale/lpr_pt.ts \
                src/qt/locale/lpr_ru.ts \
                src/qt/locale/lpr_sk.ts \
                src/qt/locale/lpr_sv.ts \
                src/qt/locale/lpr_vi.ts \
                src/qt/locale/lpr_zh_CN.ts \
                src/qt/locale/lpr_zh_TW.ts
